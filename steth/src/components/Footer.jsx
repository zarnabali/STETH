        ...
        <div className="flex flex-col md:flex-row space-y-8 md:space-y-0">
          <div className="w-full md:w-1/4 pr-8">
            ...
            <div className="flex space-x-4 mb-8">
              ...
              <a href="#" className="text-gray-400 hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.372 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 2.568-1.69 0-2.568-1.02-2.568-2.175 0-1.02.66-2.568.99-3.6 0zm12 0c0 6.627-5.373 12-12 12s-12-5.373-12-12 5.373-12 12-12 12 5.373 12 12 12 12-5.373 12-12zm0 2c6.627 0 12-5.373 12-12s-5.373-12-12-12-12 5.373-12 12 5.373 12 12 12 12zm-1.5 0c0-6.12-5.04-11.16-11.16-11.16S.84 5.88.84 12s5.04 11.16 11.16 11.16 11.16-5.04 11.16-11.16zm-1.5 0c0 5.76-4.8 10.8-10.8 10.8S1.56 17.76.84 12 5.64.84 10.44.84 16.2zm1.5 0c0-5.52.48-10.8.48-16.2 0-5.52.48-10.8.48-16.2 0-5.52.48 0 5.52.48 10.8 0 16.2z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
